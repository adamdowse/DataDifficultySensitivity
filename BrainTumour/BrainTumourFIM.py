...
def main():
    ...
    yolo.summary()
    #load_darknet_weights(yolo,"/com.docker.devenvironments.code/data/BrainTumorDetectionYolov9/yolov3.weights")
    ...
    loss = YoloLoss(yolo_anchors, classes=3)
    yolo.compile(optimizer=optimizer, loss=loss)
    yolo.fit(train_ds, epochs=10)
